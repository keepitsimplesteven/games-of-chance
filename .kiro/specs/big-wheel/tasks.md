...
- [x] 1. Define shared types and server constants
  - [x] 1.1 Add Big Wheel shared types to `packages/shared/src/types.ts`
  ...
  - [x] 1.2 Create `packages/server/src/games/big-wheel/constants.ts`
...
- [x] 2. Implement Big Wheel server plugin core logic
  - [x] 2.1 Create `packages/server/src/games/big-wheel/BigWheelPlugin.ts` with plugin skeleton
  ...
  - [x] 2.2 Write property test for pick validation
    - **Property 4: Pick validation**
    - **Validates: Requirements 8.1, 8.3, 8.4**

  - [x] 2.3 Implement `resolveRound` method in BigWheelPlugin
  ...
  - [x] 2.4 Write property test for spin result round-trip consistency
    - **Property 1: Spin result round-trip consistency**
    - **Validates: Requirements 4.3, 4.6, 5.1, 5.2, 5.3, 5.4**

  - [x] 2.5 Implement `scoreRound` method in BigWheelPlugin
  ...
  - [x] 2.6 Write property test for spin total arithmetic
    - **Property 2: Spin total is the arithmetic sum of two spin values**
    - **Validates: Requirements 4.5, 6.1**

  - [x] 2.7 Write property test for score delta equals spin total
    - **Property 8: Score delta equals spin total**
    - **Validates: Requirements 6.2, 6.3**

- [x] 3. Implement spin order, leaderboard, and disconnection logic
  - [x] 3.1 Implement spin order determination helper
  ...
  - [x] 3.2 Write property test for spin order respects session rank
    - **Property 6: Spin order respects session rank**
    - **Validates: Requirements 3.1, 3.2, 3.3, 3.4**

  - [x] 3.3 Implement `computeGameLeaderboard` method in BigWheelPlugin
  ...
  - [x] 3.4 Write property test for leaderboard ordering invariant
    - **Property 5: Leaderboard ordering invariant**
    - **Validates: Requirements 7.1, 7.2, 7.4**

  - [x] 3.5 Implement reel strip validation helper
  ...
  - [x] 3.6 Write property test for reel strip validation
    - **Property 3: Reel strip validation**
    - **Validates: Requirements 2.3, 2.4, 2.5**

  - [x] 3.7 Implement disconnection handling logic
  ...
  - [x] 3.8 Write property test for disconnected player zero score
...
- [x] 5. Register plugin and integrate with room lifecycle
  - [x] 5.1 Register Big Wheel plugin in GameRegistry
  ...
  - [x] 5.2 Integrate turn-based round lifecycle with room.ts
  ...
  - [x] 5.3 Add Big Wheel to `buildDefaultGameSettings` in room.ts
...
- [x] 6. Implement client-side Big Wheel UI components
  - [x] 6.1 Create `packages/client/src/games/big-wheel/BigWheelContainer.tsx`
  ...
  - [x] 6.2 Create wheel visualization components
  ...
  - [x] 6.3 Create spinner interaction components
  ...
  - [x] 6.4 Create spin order queue and leaderboard components
...
- [x] 7. Wire Big Wheel into GameView routing
  - [x] 7.1 Add Big Wheel case to `GameView.tsx` switch statement
    - Import `BigWheelContainer` and add `case "big-wheel"` in `renderGameContainer()`
    - _Requirements: 1.2_

  - [x] 7.2 Add Big Wheel game state parsing in `useGameStore`
...
- [x] 8. Checkpoint - Ensure all tests pass and UI renders correctly
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8.1 Write integration tests for full Big Wheel game flow
