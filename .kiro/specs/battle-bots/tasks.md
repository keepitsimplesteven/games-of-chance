...
- [ ] 1. Define types, constants, and shared infrastructure
  - [ ] 1.1 Create Battle Bots type definitions
  ...
  - [ ] 1.2 Create Battle Bots constants and settings schema
  ...
  - [ ] 1.3 Add BATTLE_TICK to shared message types
...
- [ ] 2. Implement Battle Engine (core simulation)
  - [ ] 2.1 Implement 1v1 battle simulation
    ...
    - Battle ends when one robot reaches 0 HP
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5_

  - [ ] 2.2 Implement FFA battle simulation
  ...
  - [ ] 2.3 Write property-based tests for battle engine
    ...
    - **Validates: Requirements 5.1, 5.3, 5.4, 5.5, 7.5**

- [ ] 3. Implement Pairing and Ranking Engines
  - [ ] 3.1 Implement pairing engine
  ...
  - [ ] 3.3 Write property-based tests for pairing engine
  ...
  - [ ] 3.4 Write property-based tests for ranking engine
...
- [ ] 4. Implement Bot Persona system
  - [ ] 4.1 Implement bot persona creation
  ...
  - [ ] 4.2 Implement bot persona robot selection
  ...
  - [ ] 4.3 Write tests for bot persona exclusion from scoring
...
- [ ] 5. Implement BattleBotsPlugin (GamePlugin interface)
  - [ ] 5.1 Create plugin scaffold and registration
  ...
  - [ ] 5.3 Implement resolveRound (Round 1 — Prep Phase)
  ...
  - [ ] 5.4 Implement resolveRound (Round 2 — 1v1 Battles)
  ...
  - [ ] 5.5 Implement resolveRound (Round 3 — Free-For-All)
  ...
  - [ ] 5.7 Implement computeGameLeaderboard
...
- [ ] 6. Integrate with room lifecycle
  - [ ] 6.1 Add pluginState to LiveRoomState
  ...
  - [ ] 6.2 Add battle-bots plugin registration to room.ts
    - Add side-effect import of `./games/battle-bots/index` in room.ts
    - _Requirements: 1.1_

  - [ ] 6.3 Implement tick emission during RESOLVING phase
  ...
  - [ ] 6.4 Handle multi-round lifecycle differences
...
- [ ] 8. Client — Prep Phase UI (Round 1)
  - [ ] 8.1 Create RobotCard component
  ...
  - [ ] 8.2 Create RobotSelector component
...
- [ ] 9. Client — Battle Phase UI (Round 2)
  - [ ] 9.1 Create HPBar component
  ...
  - [ ] 9.2 Create BattleArena component
  ...
  - [ ] 9.3 Create BattleSidebar component
...
- [ ] 10. Client — FFA Phase UI (Round 3)
  ...
  - [ ] 10.2 Create FFASidebar component
...
- [ ] 11. Client — Results and game shell
  - [ ] 11.1 Create FinalRankings component
  ...
  - [ ] 11.2 Create BattleBotsView container
  ...
  - [ ] 11.3 Add Battle Bots game tile to lobby
  ...
  - [ ] 11.4 Create placeholder robot sprites
...
- [ ] 12. Integration testing
  - [ ] 12.1 Full 3-round game flow test (4 players)
  ...
  - [ ] 12.3 Odd player count test (3 players)
  ...
  - [ ] 12.4 Bot persona scoring exclusion test
  ...
  - [ ] 12.5 Settings integration test
