...
- [ ] 1. Set up simulation package and foundational types
  - [ ] 1.1 Create `packages/simulation/` package structure
  ...
  - [ ] 1.2 Implement seeded PRNG module
  ...
  - [ ]* 1.3 Write property test for seed determinism (RNG)
    - **Property 2: Seed Determinism**
    - Verify that two `SeededRng` instances with the same seed produce identical sequences
    - **Validates: Requirements 1.4**

- [ ] 2. Implement Bot Player and Pick Generation system
  - [ ] 2.1 Create PickGenerator interface and registry
  ...
  - [ ] 2.2 Implement CoinToss PickGenerator
  ...
  - [ ] 2.3 Implement BotPlayer decision system
  ...
  - [ ]* 2.4 Write property test for bot pick validity
  ...
  - [ ]* 2.5 Write property test for uniform distribution
...
- [ ] 3. Implement SimulationCore game loop
  - [ ] 3.1 Implement `simulateGame` function
  ...
  - [ ] 3.2 Add config validation to SimulationCore
  ...
  - [ ]* 3.3 Write property test for score accumulation invariant
  ...
  - [ ]* 3.4 Write property test for game result completeness
...
- [ ] 5. Implement Statistics Reporter
  - [ ] 5.1 Implement core statistical computations
  ...
  - [ ] 5.2 Implement Gini coefficient and inequality metrics
    - Implement `computeGini(scores)` method using the sorted-scores formula
    - Integrate into `compute()` output
    - _Requirements: 5.2_

  - [ ] 5.3 Implement win-rate distribution and snowball detection
  ...
  - [ ]* 5.6 Write property test for win-rate distribution conservation
  ...
  - [ ]* 5.7 Write property test for statistical output bounds
  ...
  - [ ]* 5.8 Write property test for variance and mean correctness
    - **Property 9: Variance Non-Negativity and Mean Correctness**
    - Verify: (a) variance ≥ 0, (b) mean = sum/count, (c) stdDev = sqrt(variance)
    - **Validates: Requirements 5.1, 5.7**

- [ ] 6. Implement BatchRunner and CLI entry point
  - [ ] 6.1 Implement BatchRunner (Monte Carlo orchestrator)
  ...
  - [ ]* 6.4 Write unit tests for CLI argument parsing and error handling
...
- [ ] 8. Implement Fast-Play Adapter for Admin UI
  - [ ] 8.1 Implement FastPlayAdapter server component
  ...
  - [ ] 8.2 Integrate Fast-Play trigger into GameRoom
  ...
  - [ ] 8.3 Add simulation UI controls to client
  ...
  - [ ]* 8.4 Write unit tests for FastPlayAdapter
