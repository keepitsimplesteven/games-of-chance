...
- [x] 1. Define shared types and pure utility functions
  - [x] 1.1 Create play-names type definitions and classify function
  ...
  - [x] 1.2 Write property test for classifyCircumstance
  ...
  - [x] 1.3 Create animation types and timing utilities
  ...
  - [x] 1.4 Write property test for animation variant selection
  ...
  - [x] 1.5 Create field utility functions
  ...
  - [x] 1.6 Write property tests for field utility functions
  ...
  - [x] 1.7 Write property test for play result formatting
...
- [x] 3. Build play name pools and play art data
  - [x] 3.1 Create offense and defense play name pools
  ...
  - [x] 3.2 Create play art type definitions
  ...
  - [x] 3.3 Create offensive play art SVG data (4 plays × 3 circumstances)
  ...
  - [x] 3.4 Create defensive play art SVG data (4 plays × 3 circumstances)
  ...
  - [x] 3.5 Create PlayArtSvg renderer component
...
- [x] 4. Build hooks for state derivation
  - [x] 4.1 Create useDriveState hook
  ...
  - [x] 4.2 Create useCircumstance hook
  ...
  - [x] 4.3 Create usePlayCards hook
  ...
  - [x] 4.4 Write property test for play set correctness
...
- [x] 5. Build Framer Motion animation variants
  - [x] 5.1 Create animation variant definitions
...
- [x] 6. Build core UI components
  - [x] 6.1 Create BallMarker component
  ...
  - [x] 6.2 Create FieldPanel component
  ...
  - [x] 6.3 Create MiniScoreboard component
  ...
  - [x] 6.4 Create PlayCard component
  ...
  - [x] 6.5 Create PlayCardGrid component
  ...
  - [x] 6.6 Write property test for lock-in disabling
  ...
  - [x] 6.7 Create PlayResultLine component
  ...
  - [x] 6.8 Create HistoryDrawer component
  ...
  - [x] 6.9 Write property test for history drawer ordering
  ...
  - [x] 6.10 Create DriveCompletionOverlay component
...
- [x] 8. Build composed views and integrate
  - [x] 8.1 Create DriveView layout component
  ...
  - [x] 8.2 Create SpectatorGrid component
  ...
  - [x] 8.3 Write property test for spectator grid card count
  ...
  - [x] 8.4 Create SpectatorDriveView component
  ...
  - [x] 8.5 Write property test for spectator play card absence
  ...
  - [x] 8.6 Extend PlaycallerContainer with Phase 2 drive routing
  ...
  - [x] 8.7 Extend PlaycallerGameState shared type to include driveStates
  ...
  - [x] 8.8 Write property test for scoreboard state reflection
